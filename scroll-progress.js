...
(function () {
  ...
  var SOCIALS = [
    ...
    { name: 'Facebook', url: 'https://www.facebook.com/share/1EGf8wvLqW/',
      d: 'M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 .955.042 1.468.103a8.68 8.68 0 0 1 1.141.195v3.325a8.623 8.623 0 0 0-.653-.036 26.805 26.805 0 0 0-.733-.009c-.707 0-1.259.096-1.675.309a1.686 1.686 0 0 0-.679.622c-.258.42-.374.995-.374 1.752v1.297h3.919l-.386 2.103-.287 1.564h-3.246v8.245C19.396 23.238 24 18.179 24 12.044c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.628 3.874 10.35 9.101 11.647Z' },
    { name: 'Instagram', url: 'https://www.instagram.com/innova_alpha/',
    ...
    { name: 'TikTok', url: 'https://www.tiktok.com/@innova.alpha',
  ...
  CSS += '[data-socials]{ position:fixed; left:8px; top:calc(50% + 19vh + 20px); z-index:90; display:flex; flex-direction:column; gap:8px; opacity:0; transform:translateX(-8px); transition:opacity .6s ease, transform .6s cubic-bezier(.22,1,.36,1); }\n'
    ...
    + '@media (hover:hover){ [data-socials] > *:hover{ animation:none; color:#FFFFFF; border-color:transparent; transform:translateY(-2px) scale(1.06); box-shadow:0 10px 24px rgba(108,34,237,0.38); } [data-socials] > *:hover::before{ opacity:1; transform:scale(1); } [data-socials] > *:hover > span{ opacity:1; transform:translate(0,-50%); } }\n'
    ...
    + '@keyframes socGlow { 0%, 100% { box-shadow:0 0 12px 1px rgba(108,34,237,0.45); } 50% { box-shadow:0 0 26px 7px rgba(138,77,255,0.95); } }\n'
    + 'body[data-night] [data-socials] > *{ animation-name:socGlowNuit; }\n'
    + '@keyframes socGlowNuit { 0%, 100% { box-shadow:0 0 12px 1px rgba(138,77,255,0.45); } 50% { box-shadow:0 0 28px 8px rgba(185,140,255,0.95); } }\n'
    + '[data-socials] > *{ animation:socGlow 3.2s ease-in-out infinite; }\n'
    + '[data-socials] > *:nth-child(2){ animation-delay:.5s; }\n'
    + '[data-socials] > *:nth-child(3){ animation-delay:1s; }\n'
    + '[data-socials] > *:nth-child(4){ animation-delay:1.5s; }\n'
    + '[data-socials] [data-soon]{ cursor:default; }\n'
    + '@media (max-width: 900px){ [data-socials]{ display:none; } }\n'
    + '@media (prefers-reduced-motion: reduce){ [data-socials], [data-socials] > *, [data-socials] > *::before, [data-socials] > * > span{ transition:none;  animation:none; } }\n'
    + '@media (max-height: 700px){ [data-socials]{ left:10px; top:calc(50% + 19vh + 12px); gap:6px; } [data-socials] > *{ width:30px; height:30px; } [data-socials] svg{ width:13px; height:13px; } }\n'
